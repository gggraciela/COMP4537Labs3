module.exports = {
  getDate: () => {
    ...
    const time = date.toLocaleTimeString(); // Time (e.g., "12:52:14 PM")
    ...
    return `* ${day} ${month} ${dayOfMonth < 10 ? '0' : ''}${dayOfMonth} ${year} ${time} GMT${date.getTimezoneOffset() / -60}00 (${timeZone})`;
  }
};
